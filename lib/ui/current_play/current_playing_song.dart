...
import 'package:tai_music/utils/player/playing_controls.dart';
import 'package:tai_music/utils/player/position_seek_widget.dart';



class CurrentPlayingSong extends StatelessWidget {
  final AudioProvider con;
      ...
      body: Stack(
        children: [
          CachedNetworkImage(
            ...
            progressIndicatorBuilder: (context, url, l) => const CircularProgressIndicator(),
            fit: BoxFit.cover,
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                  ...
                                  child: IconButton(
                                    onPressed: (){},
                                    icon: const Icon(LineIcons.fastForward),
                                  )
                              ),
                              Expanded(
                                  flex: 1,
